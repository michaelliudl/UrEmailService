 ...
 */
public class EmailProviderAmazonSESTest {
	@Test
	public void testSend() {
		...
		EmailResponse response = EmailProviderAmazonSES.getInstance().send(request);
		Assert.assertEquals(EmailResponse.EmailState.InternalError, response.getStatus());
	}
}
